...
String AP = "Yuvraj singh deora";       // AP NAME
String PASS = "637617961900"; // AP PASSWORD
String API = "TEJTLN05B5F6PZ7E";   // Write API KEY
...
void loop() 
{
 ...
 String getData = "GET /update?api_key="+ API +"&"+ field +"="+String(values1)+String(values2);
